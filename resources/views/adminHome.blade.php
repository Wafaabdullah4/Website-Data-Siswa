                    ...
                    <div class="flex flex-wrap -m-4 text-center">
                        ...
                        <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div
                                ...
                                <h2 class="title-font font-medium text-3xl text-gray-900">{{ $data_kelas }}</h2>
                        ...
                        <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="text-indigo-500 w-12 h-12 mb-3 inline-block"style="color:#858585;"
                                    viewBox="0 0 640
                                ...
                                <h2 class="title-font font-medium text-3xl text-gray-900">{{ $data_guru }}</h2>
                                <p class="leading-relaxed">Guru</p>
                            </div>
                        </div>
                    </div>
                </div>
