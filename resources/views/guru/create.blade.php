            ...
            <form action="{{ route('guru.store') }}" method="post">
                ...
                <div class="flex items-center mb-5">
                    <label for="n_guru" class="w-20 inline-block text-right mr-4 text-gray-500 text-gray-500">Nama
                        Guru</label>
                    <input type="text" name="n_guru" class="form-control @error('n_guru') is-invalid @enderror"
                ...
                <div class="flex items-center mb-5">
                    <label for="n_wakel" class="w-20 inline-block text-right mr-4 text-gray-500 text-gray-500">
                        Wali Kelas</label>
                    <input type="text" name="n_wakel" value=""
                ...
                <div class="flex items-center mb-5">
                    <label for="mapel" class="w-20 inline-block text-right mr-4 text-gray-500 text-gray-500">
                        Mata Pelajaran</label>
                    <input type="text" name="mapel" value=""
