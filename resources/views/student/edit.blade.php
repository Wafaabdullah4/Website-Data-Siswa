        ...
        <div class="bg-white p-10 md:w-2/3 lg:w-1/2 mx-auto rounded">
            <form action="{{ route('student.update', $student->id) }}" method="post">
                ...
                <div class="flex items-center mb-5">
                    ...
                    <input type="text" name="jk" value="{{ $student->jk }}"
                ...
                <div class="card-body">
                    <form action="{{ route('student.update', $student->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" value="{{ $student->Kelas }}" aria-label="Default select example"
                                name="kelas" id="">
                            ...
                            <select class="form-select" value="{{ $student->jk }}" aria-label="Default select example"
                                name="jk" id="">
