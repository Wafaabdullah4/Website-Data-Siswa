...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
        integrity="sha384-ENsWIfnCkPvvEf114hfpAqX9Rv2vCEu5e0SKP63zSf5yDTCf0lErjXRSFp7PFJwL" crossorigin="anonymous">
            ...
            <div class="flex flex-col flex-1 overflow-y-auto">
                <nav class="flex-1 px-2 py-4 bg-gray-800">
                    ...
                    <a href="{{ route('guru.index') }}"
                        class="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" height="2em" class="mr-2" style="color:#858585;"
                            viewBox="0 0 640
                    ...
                    <a href="{{ route('logout') }}"
                        onclick="event.preventDefault();
                         document.getElementById('logout-form').submit();"
                        {{ __('Logout') }}
                        class="flex items-center px-4 ml-1 py-2 mt-2 text-gray-100 hover:bg-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" height="2em" class="mr-2"
