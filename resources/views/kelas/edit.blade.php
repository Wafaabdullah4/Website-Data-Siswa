        ...
        <div class="bg-white p-10 md:w-2/3 lg:w-1/2 mx-auto rounded">
            <form action="{{ route('kelas.update', $kelas->id) }}" method="POST">
                ...
                <div class="flex items-center mb-5">
                    ...
                    <input type="text" name="kls" value="{{ $kelas->kls }}"
                        class="form-control @error('kls') is-invalid @enderror"
                ...
                <div class="flex items-center mb-5">
                    <label for="n_kelas" class="w-20 inline-block text-right mr-4 text-gray-500 text-gray-500">Nama
                        Kelas</label>
                    <input type="text" name="n_kelas" value="{{ $kelas->n_kls }}"
                        class="form-control @error('n_kelas') is-invalid @enderror"
                        class="border-b-2 border-gray-400 flex-1 py-2 placeholder-gray-300 outline-none focus:border-green-400">
                ...
                <div class="flex items-center mb-5">
                    ...
                    <input type="text" name="ruangan" value="{{ $kelas->ruangan }}"
                ...
                <div class="flex items-center mb-5">
                    <label for="wakel" class="w-20 inline-block text-right mr-4 text-gray-500 text-gray-500">Wali
                        Kelas</label>
                    <input type="text" name="wakel" value="{{ $kelas->wakel }}"
